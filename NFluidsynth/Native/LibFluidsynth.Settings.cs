...
namespace NFluidsynth.Native
{
    internal static partial class LibFluidsynth
    {
        ...
        internal delegate IntPtr fluid_settings_foreach_t(IntPtr data, string name,
            [MarshalAs(UnmanagedType.SysInt)] FluidTypes type);
        ...
        [DllImport(LibraryName)]
        internal static extern void fluid_settings_copystr(fluid_settings_t_ptr settings, string name, IntPtr str,
            int len);
        ...
        [DllImport(LibraryName)]
        internal static extern void fluid_settings_getnum_range(fluid_settings_t_ptr settings, string name,
            out double min, out double max);

        [DllImport(LibraryName)]
        internal static extern void fluid_settings_setint(fluid_settings_t_ptr settings, string name,
            [MarshalAs(UnmanagedType.SysInt)] int val);

        [DllImport(LibraryName)]
        internal static extern bool fluid_settings_getint(fluid_settings_t_ptr settings, string name,
            [MarshalAs(UnmanagedType.SysInt)] out int val);

        [DllImport(LibraryName)]
        internal static extern int fluid_settings_getint_default(fluid_settings_t_ptr settings, string name);

        [DllImport(LibraryName)]
        internal static extern void fluid_settings_getint_range(fluid_settings_t_ptr settings, string name,
            [MarshalAs(UnmanagedType.SysInt)] out int min, [MarshalAs(UnmanagedType.SysInt)] out int max);
        ...
        internal static extern IntPtr fluid_settings_option_concat(fluid_settings_t_ptr settings, string name,
            string separator);

        [DllImport(LibraryName)]
        internal static extern void fluid_settings_foreach(fluid_settings_t_ptr settings, string name, IntPtr data,
